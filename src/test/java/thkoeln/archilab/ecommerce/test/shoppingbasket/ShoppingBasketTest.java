package thkoeln.archilab.ecommerce.test.shoppingbasket;
...
public class ShoppingBasketTest {
    ...
    public void testCheckout() {
        ...
        String customerEmail3 = TestHelper.CUSTOMER_DATA[3][1];
        Map<UUID, Integer> orderHistoryBefore = orderUseCases.getOrderHistory( customerEmail3 );
        ...
        Map<UUID, Integer> orderHistoryAfter = orderUseCases.getOrderHistory( customerEmail3 );
    ...
    public void testCheckoutInvalid() {
        ...
        // then
        assertTrue( shoppingBasketUseCases.isEmpty( customerEmail3 ) );
        assertTrue( shoppingBasketUseCases.isEmpty( customerEmail5 ) );
